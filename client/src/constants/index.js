...
export const CHECKING_ISCONTACT_PENDING = 'CHECKING_ISCONTACT_PENDING';
export const CHECKING_ISCONTACT_FULFILLED = 'CHECKING_ISCONTACT_FULFILLED';
export const CHECKING_ISCONTACT_REJECTED = 'CHECKING_ISCONTACT_REJECTED';

export const UPDATE_VIDEOCHATINFO = 'UPDATE_VIDEOCHATINFO';
